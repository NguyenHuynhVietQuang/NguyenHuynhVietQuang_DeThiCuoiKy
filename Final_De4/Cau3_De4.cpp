...
int main() {
    ...
    // tạo thông tin
    BasicContract* contract1 = new BasicContract("Quang", "967911085", "97 Man Thien", 100, 1000, 500, 200);
    DataFreeContract* contract2 = new DataFreeContract("Trieu", "123456789", "97 Man Thien", 200, 1000, 800, 200, 500);
    DataFixContract* contract3 = new DataFixContract("Sang", "456789123", "97 Man Thien", 50, 1000, 180, 200, 1000000);
